	...
	".scrollback-stream": {
		...
		".scrollback-icon:hover": {
			...
			".scrollback-icon-menu": {
				backgroundImage: "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACgAAAAoAgMAAADxkFD+AAAACVBMVEUnCBAzzKr///9dqy57AAAAAXRSTlMAQObYZgAAAE9JREFUGNNjYKA7YHSAM1kD4EzREDgzNBSuNETUAa4UrljUgTEErw1aq1atwMvEoa2BCaaAawHXAiiTaYVWA0zFqlUIxQiz4EqBihvoFIgAj/ARaE+bLvMAAAAASUVORK5CYII=')"
			},
